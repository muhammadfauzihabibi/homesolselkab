...
@section('content')
  ...
  <div class="d-flex align-items-center justify-content-between mb-4">
    <div>
      ...
      <p class="admin-page-subtitle">Perbarui data atau konten pengumuman.</p>
    </div>
  </div>
    ...
    <form action="{{ route('pengumuman.update', ['pengumuman' => $pengumuman->id]) }}" method="POST">
      ...
      <div class="row g-3">
        ...
        <div class="col-12 mb-2">
          ...
          <x-tiptap-editor name="content" id="content" :value="old('content', $pengumuman->content)" />
          @error('content')
        ...
        <div class="col-12">
          <div class="p-3 rounded-4 mb-2" style="background: var(--card-sub-bg);">
            ...
            <small class="text-muted d-block ms-5 mt-1 fs-8">Jika diaktifkan, pengumuman akan tampil pada website publik.</small>
          </div>
        </div>
      </div>
