...
@section('content')
  ...
  <div class="d-flex align-items-center justify-content-between mb-4">
    <div>
      <h1 class="h2 fw-extrabold mb-1 text-main">Tambah Kecamatan Baru</h1>
      <p class="text-muted-custom mb-0 fs-6">Masukkan data kecamatan dan link website resmi kecamatan.</p>
    </div>
  </div>
  ...
  <div class="glass-card p-4 shadow-sm w-100">
    <form action="{{ route('kecamatan.store') }}" method="POST">
      ...
      <div class="d-flex flex-wrap gap-2 justify-content-end pt-3" style="border-top: 1px solid var(--card-sub-bg);">
        ...
        <button type="submit" class="btn btn-dark-pill px-4 py-2 fs-7">Simpan Data Kecamatan</button>
      </div>
