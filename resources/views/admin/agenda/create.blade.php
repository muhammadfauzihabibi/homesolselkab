...
@section('content')
  ...
  <div class="d-flex align-items-center justify-content-between mb-4">
    <div>
      <h1 class="admin-page-title">Tambah Agenda Baru</h1>
      <p class="admin-page-subtitle">Buat jadwal kegiatan atau acara resmi baru untuk Pemda Solok Selatan.</p>
    </div>
  </div>
  ...
  <div class="glass-card p-4 w-100">
    <form action="{{ route('agenda.store') }}" method="POST">
      ...
      <div class="d-flex flex-wrap gap-2 justify-content-end pt-3" style="border-top: 1px solid var(--card-sub-bg);">
        ...
        <button type="submit" class="btn btn-primary px-4 py-2 fs-7">Simpan Agenda</button>
      </div>
