<div id="adminSidebar" class="sidebar-glass py-3 px-2 d-flex flex-column h-100 shadow-sm">
    ...
    <div class="d-none d-md-flex align-items-center justify-content-center mb-3 w-100">
        <button type="button" id="sidebarToggleBtn" class="btn-sidebar-toggle mb-3" title="Buka/Tutup Sidebar">
            <i class="bi bi-chevron-right fs-6" id="toggleIcon"></i>
        </button>
    </div>
    ...
    <ul class="nav nav-pills flex-column mb-auto gap-2 w-100 p-0 align-items-center">
        ...
        @can('page')
            <!-- Halaman Statis -->
            <li class="nav-item w-100 d-flex justify-content-center">
                <a href="{{ route('page.index') }}" class="sidebar-link {{ request()->routeIs('page.*') ? 'active' : '' }}"
        ...
        @can('berita')
            <!-- Berita -->
            <li class="nav-item dropdown w-100 d-flex justify-content-center">
                <a href="#"
                    class="sidebar-link {{ request()->routeIs(['berita.*', 'admin.berita.*']) ? 'active' : '' }}"
                    data-bs-toggle="dropdown" aria-expanded="false" title="Berita & Artikel">
                ...
                <ul class="dropdown-menu sidebar-dropdown">
                    <li>
                        <a class="dropdown-item {{ request()->routeIs('admin.berita.kategori.*') ? 'active' : '' }}"
                    ...
                    <li>
                        <a class="dropdown-item {{ request()->routeIs('berita.*') && !request()->routeIs('admin.berita.*') ? 'active' : '' }}"
                            href="{{ route('berita.index') }}">
                            <i class="bi bi-files me-2"></i>Kelola Berita
                        </a>
                    </li>
                </ul>
            </li>
        ...
        @can('poster')
            ...
            <li class="nav-item w-100 d-flex justify-content-center">
                <a href="{{ route('poster.index') }}"
                    class="sidebar-link {{ request()->routeIs('poster.*') ? 'active' : '' }}" title="Poster Digital">
                    <span class="sidebar-icon"><i class="bi bi-image"></i></span>
                    <span class="sidebar-text">Poster Digital</span>
                </a>
            </li>
        @endcan
        ...
        @can('kecamatan')
            ...
            <li class="nav-item w-100 d-flex justify-content-center">
                <a href="{{ route('kecamatan.index') }}"
                    class="sidebar-link {{ request()->routeIs('kecamatan.*') ? 'active' : '' }}" title="Data Kecamatan">
        ...
        @can('pengumuman')
            ...
            <li class="nav-item w-100 d-flex justify-content-center">
                <a href="{{ route('pengumuman.index') }}"
                    class="sidebar-link {{ request()->routeIs('pengumuman.*') ? 'active' : '' }}" title="Pengumuman">
        ...
        @can('agenda')
            ...
            <li class="nav-item w-100 d-flex justify-content-center">
                <a href="{{ route('agenda.index') }}"
                    class="sidebar-link {{ request()->routeIs('agenda.*') ? 'active' : '' }}" title="Agenda Kegiatan">
        ...
        @can('dokumentasi')
            ...
            <li class="nav-item w-100 d-flex justify-content-center">
                <a href="{{ route('dokumentasi.index') }}"
                    class="sidebar-link {{ request()->routeIs('dokumentasi.*') ? 'active' : '' }}" title="Dokumentasi">
        ...
        @can('unduhan')
            ...
            <li class="nav-item dropdown w-100 d-flex justify-content-center">
                <a href="#"
                    class="sidebar-link {{ request()->routeIs(['unduhan.*', 'admin.unduhan.*']) ? 'active' : '' }}"
                    data-bs-toggle="dropdown" aria-expanded="false" title="Download Center">
                    <span class="sidebar-icon"><i class="bi bi-cloud-arrow-down"></i></span>
                    <span class="sidebar-text">Download Center</span>
                    <span class="sidebar-arrow"><i class="bi bi-chevron-down"></i></span>
                </a>
                <ul class="dropdown-menu sidebar-dropdown">
                    <li>
                        <a class="dropdown-item {{ request()->routeIs('admin.unduhan.kategori.*') ? 'active' : '' }}"
                            href="{{ route('admin.unduhan.kategori.index') }}">
                            <i class="bi bi-folder me-2"></i>Kategori Dokumen
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item {{ request()->routeIs('admin.unduhan.jenis.*') ? 'active' : '' }}"
                            href="{{ route('admin.unduhan.jenis.index') }}">
                            <i class="bi bi-tags me-2"></i>Jenis Dokumen
                        </a>
                    </li>
                    <li>
                        <hr class="dropdown-divider">
                    ...
                    <li>
                        <a class="dropdown-item {{ request()->routeIs('unduhan.*') && !request()->routeIs('admin.unduhan.*') ? 'active' : '' }}"
                            href="{{ route('unduhan.index') }}">
                            <i class="bi bi-files me-2"></i>Kelola Dokumen
                        </a>
                    </li>
                </ul>
            </li>
        ...
        @role('Super Admin')
            <!-- Pemisah Manajemen Sistem -->
            <li class="w-100 my-2 border-top" style="border-color: rgba(76, 135, 186, 0.15) !important;"></li>

            <li class="nav-item w-100 d-flex justify-content-center">
                <a href="{{ route('users.index') }}"
                    class="sidebar-link {{ request()->routeIs('users.*') ? 'active' : '' }}" title="Manajemen Pengguna">
            ...
            <li class="nav-item w-100 d-flex justify-content-center">
                <a href="{{ route('roles.index') }}"
                    class="sidebar-link {{ request()->routeIs('roles.*') ? 'active' : '' }}" title="Manajemen Role">
        ...
        <li class="nav-item w-100 d-flex justify-content-center">
            <form method="POST" action="{{ route('logout') }}" class="w-100 d-flex justify-content-center"
                id="logout-form">
                @csrf
                <button type="submit" class="sidebar-link text-danger border-0 bg-transparent"
                    title="Keluar / Logout">
